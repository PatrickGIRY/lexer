...
public class OneCaptureGroupPatternShould {
    ...
    void be_created_only_with_one_captured_group(String regex) {
        ...
        assertThatThrownBy(() -> new OneCaptureGroupPattern(pattern))
    ...
    void be_created_only_with_non_null_pattern() {
        ...
        assertThatThrownBy(() -> new OneCaptureGroupPattern(NULL_PATTERN))
